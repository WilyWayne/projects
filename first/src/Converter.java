public class Converter {
    static  String[] romanArray = new String[] {
            "null", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI",
            ...
            "LVI", "LVII", "LVIII", "LVIX", "LX", "LXI", "LXII", "LXIII", "LXIV", "LXV", "LXVI", "LXVII", "LXVIII",
    ...
    public static String convertToRoman(int pro) {
        return romanArray[pro];
    }
}
